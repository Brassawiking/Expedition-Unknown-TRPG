...
A new round begins and Steve is first to act again. Steve sees a control panel close by and says "Cover me, I can get the lights back on!" The escorts have no objections and follows Steve. Steve starts to fix the lights. GM tells Steve to roll for stress check which he passes, GM then gives him an sudoku to solve and Steve turns is done.
